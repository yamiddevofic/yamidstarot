  ...
  return (
    <div className="relative">
      ...
      <motion.div
        ...
        variants={uiElements.backgroundGlow}
        initial="idle"
      ...
      {/* Botón principal */}
      <motion.button
        className="w-auto px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600
        text-white font-bold rounded-xl shadow-lg hover:shadow-purple-600/40
