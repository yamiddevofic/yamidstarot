    ...
    <div className="container mx-auto px-4 ">
      <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center justify-center">
        ...
        <div className="flex order-1 md:order-2 flex-col justify-center">
          <h2 className="text-3xl sm:text-4xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent text-center md:text-left">
            Mi enfoque espiritual
          </h2>
          <p className="text-gray-300 text-base sm:text-lg leading-relaxed mb-8 text-center md:text-left">
